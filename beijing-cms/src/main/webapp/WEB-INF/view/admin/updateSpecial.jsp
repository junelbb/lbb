      ...
      <div id="content-wrapper">
        ...
        <div class="container-fluid">
          ...
          <div class="row">
          	...
          	<input type="hidden" name="id" value="${spcialArticle.id }">
            <table class="table table-hover">
            	<tr>
            		<td>专题标题</td>
            		<td><input type="text" name="title" value="${spcialArticle.title }"></td>
            	</tr>
            	<tr>
            		<td>专题摘要</td>
            		<td>
            			<textarea rows="5" cols="35" name="abstr">${spcialArticle.abstr }</textarea>
            		</td>
            	</tr>
            	<tr>
            		<td>
